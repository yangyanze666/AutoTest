...
class TestJinYangApiCreateModifyDelete:
    ...
    @pytest.mark.parametrize("url_path, request_method, headers, params, json, data, except_code, except_msg",
                             get_excel_data("jy_add_modify_delete.xlsx", "新增泵站信息"))
    def test_add_pump_station_api(self, url_path, request_method, headers, params, json, data, except_code, except_msg):
        """
        金阳项目-新增泵站信息
        """
    ...
    @pytest.mark.parametrize("url_path, request_method, headers, params, json_data, data, except_code, except_msg",
                             get_excel_data("jy_add_modify_delete.xlsx", "泵站信息唯一性校验"))
    ...
    @pytest.mark.parametrize("url_path, request_method, headers, params, json_data, data, except_code, except_msg",
                             get_excel_data("jy_add_modify_delete.xlsx", "泵站信息更新"))
    def test_modify_pump_station_api(self, url_path, request_method, headers, params, json_data, data, except_code,
                                except_msg):
        """
        金阳项目-泵站管理-修改泵站信息
        """
    ...
    @pytest.mark.parametrize("url_path, request_method, headers, params, json_data, data, except_code, except_msg",
                             get_excel_data("jy_add_modify_delete.xlsx", "删除泵站信息"))
    def test_delete_pump_station_api(self, url_path, request_method, headers, params, json_data, data, except_code,
                                except_msg):
        """
        金阳项目-泵站管理-删除泵站信息
        """
